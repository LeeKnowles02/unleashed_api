...
-- =============================================================================
-- Detailed integration / process log (verbose troubleshooting)
-- =============================================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_integration_log_created_at' AND object_id = OBJECT_ID('unleashed.integration_log'))
CREATE NONCLUSTERED INDEX IX_integration_log_created_at ON unleashed.integration_log ([created_at] DESC);
GO

-- =============================================================================
-- Run summary table: one row per full execution
-- =============================================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_sync_run_start_time' AND object_id = OBJECT_ID('unleashed.sync_run'))
CREATE NONCLUSTERED INDEX IX_sync_run_start_time ON unleashed.sync_run ([start_time] DESC);
GO
